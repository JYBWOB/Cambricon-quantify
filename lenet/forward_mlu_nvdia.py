...
prototxt_path = './models/lenet_qtz_nvdia.prototxt'
...
y_test = y_test.reshape((total_num, 1))
...
while(cur_index < total_num):
    ...
    if cur_index + batch_size < total_num:
        ...
        test_label = y_test[cur_index: cur_index + batch_size]
    else:
        test_data = x_test[cur_index:, :]
        test_label = y_test[cur_index:]
